...
8. *Process excellence* is important. The ability to follow a structured,
   ...
   53).
9. The majority of the time spent is *not* spent on solving the client's problem
   - it's spent on isolating the underlying cause of the client's problem. Never
     ever propose a solution to a case until you've isolated and defined the
     problem. Then and only then can you propose a solution (p. 97).
